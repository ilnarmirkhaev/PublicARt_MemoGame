...
namespace Core
{
    ...
    {
        public static async Task AnimateLabel(Label label, int startFontSize, int endFontSize, int number, float duration)
        {
        ...
        public static TweenerCore<Vector3, Vector3, VectorOptions> AnimateRotation(VisualElement element, float angle, LoopType loopType = LoopType.Yoyo, Ease ease = Ease.InOutCirc)
        {
        ...
        public static void AnimateWidth(VisualElement element, float max, float min, LoopType loopType = LoopType.Yoyo, Ease ease = Ease.InOutCirc)
        {
